using System;
/// XXXXXXXX
// This class is used to override the internal TrueDualPortMemory, so we can debug it in code
namespace SME.Components
{
    ...
    public class TrueDualPortMemory<T> : SimpleProcess
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:SME.Components.SimTrueDualPortMemory`1"/> class.
        /// </summary>
