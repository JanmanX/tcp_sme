...
\notecarl{SoC referer til et helt system, f.eks. et board, ikke en chip. En SoC har oftest en ASIC eller en FPGA. Senere refererer i til Zynq, som ganske rigtigt kan betragtes som en SoC, fordi den både har en ARM processor, en FPGA osv.}
...
\notecarl{Side note: man laver også boards med FPGA, hvor deres bitstream er gemt i en ROM, så de heller ikke kan blive reflashet. Eller rettere sagt, en FPGA kan kun blive reflashet, hvis man designer boardet til at kunne det. Men generelt har i ret!}
, \gls{cpld} are
...
external memory chips, \gls{cpld} can only utilize built-in non-volatile
memory.
...
\notecarl{Skal en CPU og GPU dog også}
