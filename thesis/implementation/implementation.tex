...
The "synchronous" approach using a \texttt{SimpleProcess} in
\autoref{fig:sme_example_process_sync_code}
%\notemark{Fix autoref}
has to implement a
...
The asynchronous approach on
\autoref{fig:sme_example_process_async_code}
%\notemark{Fix autoref}
...
maintaining simplicity, as seen on the statemachine diagram on
\autoref{fig:sme_example_process_fsm}.
%\notemark{Fix autoref}
...
\end{itemize}
An overview of this can be seen in \autoref{tab:buffer_requirements}.\\
\begin{table}[htpb]
  \begin{center}
