...
multiple hours. In about 10 million clock cycles, the networking stack was able
to handle 118400 packets in total, where 1280 of the packets were valid
...
$$10 000 000\, \mathbf{bytes} = 10 000\, \mathbf{KB} = 10\,\mathbf{MB}$$
$$\frac{10\:\mathbf{MB}}{10\:\mathbf{MHz}} = 8\:\mathbf{Mbps}$$
