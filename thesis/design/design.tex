...
of new protocols\noteinfo{Vi gjorde jo sådan set ikke det, slet?} affect the performance, scalability, and viability of the
system.\\
...
Furthermore, the general purposeness\noteinfo{Er det et ord?} of the memory makes it very hard to
...
pass through each state, letting each stage\noteinfo{Stage or state?} parse the required information, and
...
\begin{figure}
    ...
    \notejan[inline]{Synes du forklaringen af denne metode er OK?}
\end{figure}
