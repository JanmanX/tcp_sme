...
\begin{frame}[fragile]
    %\Put(280,0){\colorbox{white}{\includegraphics[width=0.2\textwidth]{implementation/design_2_state.eps}}}
    \frametitle{\ImplementationTitle}
...
\begin{frame}[fragile]
    %\AtPageUpperLeft{\colorbox{white}{\includegraphics[width=0.2\textwidth]{implementation/design_2_state.eps}}}
    \frametitle{\ImplementationTitle}
    \framesubtitle{Processes}
    Examples\\
