...
\AtBeginSection[]
{
  \begin{frame}
    ...
    \begin{columns}
      \begin{column}{0.4\textwidth}
        \tableofcontents[sections=<1-4>,subsectionstyle=shaded/show/hide,sectionstyle=show/shaded]
      \end{column}
      \begin{column}{0.4\textwidth}
        \tableofcontents[sections=<5->,subsectionstyle=shaded/show/hide,sectionstyle=show/shaded]
      \end{column}
  \end{columns}
    \end{frame}
}
